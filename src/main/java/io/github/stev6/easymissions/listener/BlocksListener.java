...
import io.github.stev6.easymissions.type.impl.Break;
import io.github.stev6.easymissions.type.impl.Harvest;
import io.github.stev6.easymissions.type.impl.Place;
...
import static io.github.stev6.easymissions.util.ListenerUtils.*;
...
public record BlocksListener(MissionManager m, RecentPlaceCache c) implements Listener {
    ...
    public void onBreak(BlockBreakEvent e) {
        ...
        m.findAndModifyFirstMission(e.getPlayer(), Break.INSTANCE, BlockContext.from(e), mission -> mission.incrementProgress(amount));
    }
    ...
    public void onHarvest(BlockBreakEvent e) {
        ...
        m.findAndModifyFirstMission(e.getPlayer(), Harvest.INSTANCE, new BlockContext(b), mission -> mission.incrementProgress(amount));
    }
