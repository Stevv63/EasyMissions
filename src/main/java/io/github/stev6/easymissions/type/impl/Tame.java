...
public class Tame implements TargetedMissionType<EntityContext, Tame.TameData> {
    public static final Tame INSTANCE = new Tame();
    private static final String ID = "tame";
    ...
    @Override
    public @NotNull TameData parse(@NotNull ConfigurationSection section) {
        ...
        return new TameData(entityMatcher);
    }

    public record TameData(@Nullable EntityDataMatcher entityMatcher) implements MissionTarget<EntityContext> {
        @Override
