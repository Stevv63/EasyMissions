...
public class Shear implements TargetedMissionType<EntityContext, Shear.ShearData> {
    public static final Shear INSTANCE = new Shear();
    private static final String ID = "shear";
    ...
    @Override
    public @NotNull ShearData parse(@NotNull ConfigurationSection section) {
        ...
        return new ShearData(entityMatcher);
    }

    public record ShearData(@Nullable EntityDataMatcher entityMatcher) implements MissionTarget<EntityContext> {
        @Override
