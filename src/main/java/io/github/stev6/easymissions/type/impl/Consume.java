...
public class Consume implements TargetedMissionType<ItemContext, Consume.ConsumeData> {
    public static final Consume INSTANCE = new Consume();
    private static final String ID = "consume";
    ...
    @Override
    public @NotNull ConsumeData parse(@NotNull ConfigurationSection section) {
        ...
        return new ConsumeData(itemMatcher);
    }

    public record ConsumeData(@Nullable ItemDataMatcher itemMatcher) implements MissionTarget<ItemContext> {
        @Override
